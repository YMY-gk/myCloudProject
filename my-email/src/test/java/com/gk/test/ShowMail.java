...
public class ShowMail {
    ...
    public static void main(String args[]) throws Exception {
        ...
        String postCount="3436054021@qq.com";//发送者账户
        String username = postCount;
        String password = "vvgykdjzdtxpdcbg";
        ...
        store.connect("pop.qq.com", "571318664@qq.com", "reeokuwvsezabfbg");
